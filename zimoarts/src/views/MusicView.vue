<template>
    <div class="music">
        ...
        <PageTopBigImageComponent titleOne="MUSIC" titleTwo="ART" titleColor="#ffffff"
            backgroudPicUrl="http://www.grotonarts.com/static/music/music-top-bg.png"
        ...
        <InterviewColumnComponent backgroudPicUrl="http://www.grotonarts.com/static/music/music-interview-bg.png"
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            httpRequest.get("http://www.grotonarts.com/static/music/music-image-list.json").then(function (response) {
